...
exports.productsRouter.get("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const products = yield products_repository_1.productsRepository.findProducts((_a = req.query.title) === null || _a === void 0 ? void 0 : _a.toString());
    res.send(products);
}));
...
exports.productsRouter.post("/", titleValidation, input_validate_middleware_1.inputValidaionMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const products = yield products_repository_1.productsRepository.createProduct(req.body.title);
...
exports.productsRouter.put("/:id", titleValidation, input_validate_middleware_1.inputValidaionMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const isChange = yield products_repository_1.productsRepository.changeProductName(+req.params.id, req.body.title);
    if (isChange) {
        const products = yield products_repository_1.productsRepository.findProducts();
        res.send(products);
    }
    else {
        res.send(404);
